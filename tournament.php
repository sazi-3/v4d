...
<div class="tournament-hero">
  <?php if ($tournament['banner']): ?>
    <img src="<?= upload_url("banners/" . $tournament['banner']) ?>" alt="<?= sanitize($tournament['name']) ?>" class="tournament-hero-img">
  <?php else: ?>
          ...
          <a href="player.php?id=<?= $p['id'] ?>" class="t-stat-card glass-card">
            ...
            <div class="t-stat-player">
              <?php if ($p['profile_pic']): ?>
                <img src="<?= upload_url("profiles/" . $p['profile_pic']) ?>" alt="" class="t-stat-avatar" style="border-color:<?= sanitize($p['border_color']) ?>">
              <?php else: ?>
