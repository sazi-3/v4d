  ...
  endforeach; ?>
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <img src="<?= upload_url("profiles/" . $edit_player['profile_pic']) ?>" class="upload-preview-img"
          ...
          <div class="form-group">
            ...
            <img src="<?= upload_url("covers/" . $edit_player['cover_image']) ?>" class="upload-preview-cover"
