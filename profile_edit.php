        ...
        <div class="form-row">
          <div class="form-col">
            ...
            <div class="preview-box">
              <img src="<?= upload_url("profiles/" . $player['profile_pic']) ?>" alt="Current Profile">
            </div>
            <?php endif; ?>
          </div>
          ...
          <div class="form-col">
            ...
            <div class="preview-box">
              <img src="<?= upload_url("covers/" . $player['cover_image']) ?>" alt="Current Cover">
            </div>
            <?php endif; ?>
          </div>
        </div>
        ...
        <div class="form-row">
          ...
          <div class="form-col">
            ...
            <select name="font_style" class="form-control" id="font_style_input">
              ...
              <option value="lobster" <?= $player['font_style'] === 'lobster' ? 'selected' : '' ?>>Lobster (Fancy)</option>
              <option value="titillium" <?= $player['font_style'] === 'titillium' ? 'selected' : '' ?>>Titillium (Tech)</option>
              <option value="righteous" <?= $player['font_style'] === 'righteous' ? 'selected' : '' ?>>Righteous (Modern)</option>
            </select>
          </div>
        </div>
